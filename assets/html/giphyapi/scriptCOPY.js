...
$(document).ready(function () {
    ...
    function gifDisplay() {
        if ($('#gif-input').val().length > 0) {
            ...
            $('#main').append('<div class="" id="rating"><h3>Rating: ' + response.data[x].rating + '</h3><img src="' + response.data[x].images.downsized.url + '" data-animate="' + response.data[x].images.downsized.url + '" data-still="' + response.data[x].images.downsized_still.url + '" data-state="still" class="img"></div>');
...
// <div class=" boxDiv" id="rating"><h3>Rating: </h3>

// <img src="' '" data-animate="' '" data-still="'  '" data-state="still" class="img"/>
